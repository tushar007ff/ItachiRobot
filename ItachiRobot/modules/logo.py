...
from ItachiRobot.modules.nightmode import button_row
from ItachiRobot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./ItachiRobot/resources/fonts/*")
