...
from ItachiRobot import OWNER_ID, pbot
from ItachiRobot.utils.admins import can_change_info
from ItachiRobot.utils.errors import capture_err
from ItachiRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|Rudra|thank you|gud|thankyou|love|pro)$"
regex_downvote = r"^(\-|\-\-|\-1|\👎|💔|Rudra|weak|fuck off|nub|gey|mf)$"
