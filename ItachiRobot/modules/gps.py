...
@Rudra.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        ---------telegram : @Rudra_Jaat-----
        """
        geolocator = Nominatim(user_agent="legend-Rudra")
#         zoom=[0-18]
...
@Rudra.on_message(filters.command(["distance"]))
...
# Rudra.add_handler(MessageHandler(gps))     
# Rudra.add_handler(MessageHandler(distance))
