...
from ItachiRobot import (
    BOT_NAME,
    BOT_USERNAME)
from ItachiRobot import telethn as tbot
from ItachiRobot.events import register
from ItachiRobot.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
...
button_row = [
        [Button.url('🌺•─╼⃝𖠁𝐀𝙳𝙳 ◈ 𝐌𝙴 ◈ 𝐁𝙰𝙱𝚈𖠁⃝╾─•🌺', f'https://t.me/{BOT_USERNAME}?startgroup=new')]
    ]
