...
import ItachiRobot.modules.sql.global_bans_sql as gban_sql
import ItachiRobot.modules.sql.users_sql as user_sql
from ItachiRobot import DEV_USERS, OWNER_ID, dispatcher
