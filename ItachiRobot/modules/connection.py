...
import ItachiRobot.modules.sql.connection_sql as sql
from ItachiRobot import DEV_USERS, DRAGONS, dispatcher
from ItachiRobot.modules.helper_funcs import chat_status
