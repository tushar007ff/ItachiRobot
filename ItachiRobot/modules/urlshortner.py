...
@Rudra.on_message(filters.command(["short"]))
...
@Rudra.on_message(filters.command(["unshort"]))
...
# Rudra.add_handler(MessageHandler(short_urls))
# Rudra.add_handler(MessageHandler(unshort))
__help__ = """
