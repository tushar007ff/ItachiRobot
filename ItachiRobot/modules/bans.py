...
from ItachiRobot.modules.helper_funcs.extraction import extract_user_and_text
from ItachiRobot.modules.helper_funcs.string_handling import extract_time
from ItachiRobot.modules.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        return log_message
    if user_id == bot.id:
        message.reply_text("ᴏʜ ʏᴇᴀʜ, ʙᴀɴ ᴍʏsᴇʟғ, ʀᴜᴅʀᴀ!")
        return log_message
