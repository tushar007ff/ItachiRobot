...
if ENV:
    ...
    from ItachiRobot.config import Development as Config
...
telethn = TelegramClient("Rudra", API_ID, API_HASH)

pbot = Client("ItachiRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
...
from ItachiRobot.modules.helper_funcs.handlers import (
